...
------------------------------------------------------------------------------------------------ */
let stg = ['hi', 'how', 'are', 'you'];
const addExclamation = (arr) => {
  console.log(`${arr}!`);
};
stg.forEach(addExclamation);
...
------------------------------------------------------------------------------------------------ */
let upper = ['hi', 'how', 'are', 'you'];
const allUpperCase = (arr) => {
  console.log(arr.toUpperCase());
};
upper.forEach(allUpperCase);
...
------------------------------------------------------------------------------------------------ */
let stu = ['hello', '301', 'students']
const greeting = (word) => {
  console.log(`${word.toUpperCase()} !`);
};
stu.forEach(greeting);
